    ...
    <section className="content-wrap">
      ...
      <div className="content"> 
        ...
        <article className="text-black text-base font-normal leading-normal pb-3 pt-1">
          Create things. Market things. <span className='standout-01'>Make ideas come true</span>. We are a creative technology company. But even more, a passionate group of doers, awakening our inner child's and manifesting the kind of world in which we want to live.
          <br /><br />
